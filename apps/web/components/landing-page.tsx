...
export function LandingPage({ onEnter, isExiting }: LandingPageProps) {
  return (
    <main
      className={`flex min-h-screen flex-col items-center justify-center px-6 transition-all duration-700 ease-out ${isExiting ? "pointer-events-none scale-[0.98] opacity-0" : "scale-100 opacity-100"
        }`}
    >
